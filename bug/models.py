...
class Bug(models.Model):
    ...
    bugname = models.CharField(verbose_name='bug 名称', max_length=64)  # Bug 名称
    bugdetail = models.CharField(verbose_name='详情', max_length=200)  # 详情
    ...
    bugcreater = models.CharField(verbose_name='创建人', max_length=200)  # 创建人
    bugassign = models.CharField(verbose_name='被分配人', max_length=200)  # 分配给
